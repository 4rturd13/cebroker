    ...
    return (
        <form className="formFilterCourses" action="">
            ...
            <div className="subtitleFilter">
                ...
                <div className="radio selectItem">
                    <input type="radio" id="featured-1" name="featured" />
                    <label htmlFor="featured-1">Self paced</label>
                    <input type="radio" id="featured-2" name="featured" />
                    <label htmlFor="featured-2">Live</label>
                </div>
            </div>
            <div className="subtitleFilter">
                <div className="subtitles">
                ...
                <div className="radio selectItem">
                    ...
                    <label htmlFor="featured-3">Any delivery type</label>
                    <input type="radio" id="featured-4" name="featured" />
                    <label htmlFor="featured-4">Computer-Based Training</label>
                    <input type="radio" id="featured-5" name="featured" />
                    <label htmlFor="featured-5">Correspondece</label>
                    <input type="radio" id="featured-6" name="featured" />
                    <label htmlFor="featured-6">Mailed Material</label>
